...
module Oriented
  module Core
    module Property
      ...
      def []=(key, value)
        raise "Not valid OrientDB Property value #{value.class} for key #{wrapper.class.name}##{key}, valid: #{VALID_PROPERTY_VALUE_CLASSES.to_a.join(', ')}" unless valid_property?(value)
